...
const deDE: typeof enUS = {
  ...enUS,
  discover: { ...enUS.discover, title: 'Entdecken', reviewSession: 'Session prüfen', modes: { forYou: 'Für dich', trending: 'Trends', hiddenGems: 'Geheimtipps', newReleases: 'Neuerscheinungen', nineties: '90er' } },
