Create one horizontal animation strip for Codex pet `reel`, state `running-right`.
...
Identity: same pet in every frame: A tiny cinematic archivist-builder companion: compact whole-body mascot, dark navy body like a polished film canister, warm yellow scarf/accent, expressive bright eyes, small slate/clipboard-like chest patch without text, curious focused personality, no logos or readable text.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Soft 3D toy/sticker hybrid, clean silhouette, readable at pet size, flat chroma background, no shadows or scenery..
